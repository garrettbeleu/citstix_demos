...
class Grow {
  ...
  public void blockGrowthMaster(float[][] ar, float[][] ag, float[][] ab, int kr, int kg,int kb, ArrayList cr,ArrayList cg,ArrayList cb) {
...
class Orb { 
  ...
  //Constructor
  Orb (Vec3D _loc, Puddle _p, ArrayList _c, int _k) {  
    loc = _loc;
    p = _p;
    c = _c;
    k = _k;
